...
Generated: 2026-06-08T13:07:45+00:00
Source parquet: `/home/blackwell/Desktop/ranymizer/pii-model/data/raw/swedish_pii_synthetic`
Recipe revision (git): `d90877f`
...
classification.
  ...
  - `entities` — 24 examples — NER over the 12 PII labels.
  - `classification` — 24 — multi-label `sensitivity` (direct_pii / art9_health / art9_religion_ethnicity / art10_criminal / no_sensitive).
  - `json_structures` — 23 — one `person_record` per single-subject fragment.
  - `relations` — 23 — `belongs_to(identifier → person)` for single-subject fragments.
...
- Split ratios: 0.70 / 0.15 / 0.15
  (`TrainingDataset.split` with seed = 0).
